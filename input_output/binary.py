...
# for i in range(17):
#     bin_file.write(bytes([i]))  we pass a list in the byte function
# because if we pass a integer in the byte function it creates a
# byte sequence with that many bytes with all set to zero
...
with open("binary2", 'br') as bin_file:
    ...
    print(h)
    # here 'i' value is different as we stored in little and read in big
